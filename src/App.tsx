...
export default function App() {
  ...
  const contactSupport = () => window.open(`https://wa.me/${WHATSAPP_PHONE}?text=${encodeURIComponent('Olá! Acessei o catálogo da Pais Store e gostaria de tirar uma dúvida sobre disponibilidade.')}`, '_blank', 'noopener,noreferrer');
  ...
  return (
    <div className="flex min-h-screen flex-col justify-between bg-[#fafafa] font-sans text-gray-900 antialiased selection:bg-red-500 selection:text-white">
      ...
      <main className="flex-1">
        <Hero onExploreCatalog={() => navigate('catalogo')} onContactSeller={contactSupport} highlightProduct={featuredProducts[0] ?? products.find((product) => product.available)} />
        <HowItWorks />
